...
require_once CUA_DIR . 'includes/class-cua-mcp-official-transport.php';

$cua_mcp_autoload = CUA_DIR . 'vendor/autoload.php';
if ( is_readable( $cua_mcp_autoload ) ) {
	require_once $cua_mcp_autoload;
}

CUA_Audit::bootstrap();
CUA_MCP_Settings_Page::register_admin_hooks();
CUA_OAuth_Server::bootstrap();
CUA_MCP_Official_Transport::bootstrap();
...
add_action( 'wp_abilities_api_init', array( 'CUA_MCP_Diagnostics', 'register_discovery_ability' ), 5 );
