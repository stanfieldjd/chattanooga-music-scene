...
wp_set_current_user( 1 );
echo "cmsa-native-mcp: PASS version=1.2.2 modern=2026-07-28 legacy=2025-11-25 route=verified oauth_challenge=verified admin_boundary=verified origin_guard=verified tools_list=deterministic read_call=verified private_bridges=hidden header_validation=verified\n";
exit( 0 );
