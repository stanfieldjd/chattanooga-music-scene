...
cmsa_native_mcp_assert( defined( 'CUA_VERSION' ) && 1 === preg_match( '/^\\d+\\.\\d+\\.\\d+$/', CUA_VERSION ), 'Chattanooga CMS Admin version did not load as a semantic version.' );
...
echo "cmsa-native-mcp: PASS version=" . CUA_VERSION . " protocol=2026-07-28 route=verified administrator_surface=bounded-public origin_guard=verified tools_list=bounded-deterministic oauth_scheme=verified read_call=verified header_validation=verified\n";
exit( 0 );
