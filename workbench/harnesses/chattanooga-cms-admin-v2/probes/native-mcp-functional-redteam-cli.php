...
cmsa_mcp_redteam_assert( defined( 'CUA_VERSION' ) && '1.2.47' === CUA_VERSION, 'Chattanooga CMS Admin 1.2.47 is not active.' );
cmsa_mcp_redteam_assert( defined( 'EM_VERSION' ) && '7.4.3' === (string) EM_VERSION, 'Events Manager 7.4.3 is not active.' );
cmsa_mcp_redteam_assert( defined( 'CMS_CORE_VERSION' ) && '0.2.3' === CMS_CORE_VERSION, 'Weekend Feature 0.2.3 is not active.' );
