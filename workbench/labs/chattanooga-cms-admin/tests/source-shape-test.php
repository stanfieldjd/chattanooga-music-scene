...
foreach ( array( 'class-cmsa-errors.php', 'class-cmsa-audit.php', 'class-cmsa-backups.php', 'class-cmsa-health.php', 'class-cmsa-updates.php', 'class-cmsa-lifecycle.php', 'class-cmsa-content.php', 'class-cmsa-abilities.php', 'class-cmsa-content-abilities.php', 'class-cmsa-plugin.php' ) as $required_include ) {
...
if ( false === strpos( $coordinator, 'new CMSA_Content_Abilities' ) || false === strpos( $coordinator, 'new CMSA_Content()' ) ) {
	fwrite( STDERR, "Content ability registrar is not wired into the coordinator.\n" );
	exit( 1 );
}

foreach ( array( $abilities, $content_abilities ) as $registration_source ) {
