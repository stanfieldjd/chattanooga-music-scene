...
| 3 | WordPress/plugin/theme maintenance | VERIFY_FIRST | Refresh the live update inventory only after selecting this workstream; update one component at a time with rollback and post-update validation. |
